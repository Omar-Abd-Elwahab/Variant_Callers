...
# Duplicate marking
$sentieon driver -r /path/to/reference/ref.fna -t 16 -i /path/to/bam_illumina/HG003_sorted.bam --algo LocusCollector \
    --fun score_info /path/to/bam_illumina/HG003_score.txt.gz
$sentieon driver -r /path/to/reference/ref.fna -t 16 -i /path/to/bam_illumina/HG003_sorted.bam --algo Dedup \
    --score_info /path/to/bam_illumina/HG003_score.txt.gz \
    /path/to/bam_illumina/HG003_deduped.bam
