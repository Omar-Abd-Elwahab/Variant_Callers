...
$sentieon bwa mem -t 16 -K 10000000 -R '@RG\tID:003\tSM:HG003\tPL:ILLUMINA' -Y /path/to/references/ref.fna \
...
$sentieon driver -r /path/to/references/ref.fna -t 16 -i /path/to/bam_illumina/HG003_sorted.bam --algo Dedup \
